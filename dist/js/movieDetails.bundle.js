...
function _createSimilarMovies() {
  _createSimilarMovies = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(movie) {
    var similarMoviesContainer, similarMoviesTitle, similarMoviesBox, imagesContainer, myApiUrl, data, movies, MAX_DISPLAY;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          if (true) {
            myApiUrl = "".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_1__.config.devApiUrl, "/v1/movies/").concat(movie.id, "/similar-movies?page=1&limit=10");
          } else {}
          _context2.next = 7;
        ...
        case 0:
          ...
          form.addEventListener('submit', /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(event) {
              var commentData, createCommentApiUrl;
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    if (true) {
                      createCommentApiUrl = "".concat(_config_config_js__WEBPACK_IMPORTED_MODULE_1__.config.devApiUrl, "/v1/movies/").concat(movie.id, "/comments");
                    } else {}
                    _context6.prev = 3;
                    _context6.next = 6;
                    return axios.post(createCommentApiUrl, JSON.stringify(commentData), {
                      headers: {
